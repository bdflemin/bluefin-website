...
describe('wolves thesis sequence', () => {
  it('preserves the approved thesis timing and final call to action', () => {
    ...
    expect(getWolvesThesisState(348)).toMatchObject({ active: true, mode: 'welcome', text: 'You\'ll never walk alone ...', dayPulse: true, hudLabel: 'Incoming Signal: Universal Blue' })
