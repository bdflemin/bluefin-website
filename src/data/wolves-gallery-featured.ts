export const ghostsInTheMistOpeningSlide = {
  ...
  descriptionParts: [
    ...
    'If you\'re new to cloud native then I hope this small glimpse of the people will inspire to work in your own local communities. Be the one who moves, not the one who is moved. With you at our side, how can we fail?',
