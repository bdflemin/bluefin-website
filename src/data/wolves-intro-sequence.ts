  ...
  return [
    {
      ...
      // - Kaslin Fields' Arc Warlock lightning duel runs 37-48s, beginning on her visible
      ...
      //   the same shot from ~86.5-90s onward, so their windows overlap (82-95s and
      //   86.5-96s) with `position` anchoring each to its own side of the frame instead of one
      ...
      overlays: [
        ...
        { text: 'Stormcaller Warlock — Kaslin Fields — Rage of the Paradox', start: 37, end: 48 },
        ...
        { text: 'Broodweaver Warlock — Christoph Blecker — First Among Equals — The North Star', start: 82, end: 95, position: 'left', trustee: true, leader: true },
        { text: 'Behemoth Titan — Natali Vlatko — Shipwright of Kubernetes', start: 86.5, end: 96, position: 'right', raised: true },
